$(document).ready(function() {
    ...
    function pagarPayu() {
        ...
        $(".formPayu input[name='responseUrl']").attr("value", "http://localhost/productos2/index.php");
        $(".formPayu input[name='declinedResponseUrl']").attr("value", "http://localhost/productos2/Rdeclinada.html");
