...
class usuariosAjax
{
    ...
    {
        $objRespuesta = usuariosControlador::fnCtrRegistrarUsuarios($this->nombres, $this->apellidos, $this->telefono, $this->imagen);
    ...
    {
        $objRespuesta = usuariosControlador::fnCtrEditarUsuarios($this->idUsuario, $this->nombres, $this->apellidos, $this->telefono, $this->imagen, $this->urlAnterior);
        $respuesta['resultado'] = array($objRespuesta);
        echo json_encode($respuesta);
    }
...
// insertar usuario
if (isset($_POST["envioNombre"]) && isset($_POST["envioApellidos"]) && isset($_POST["envioTelefono"])) {
...
// modificar usuario
if (isset($_POST["idEditarUsuario"]) && isset($_POST["editarNombre"]) && isset($_POST["editarApellidos"]) && isset($_POST["editarTelefono"])) {
    $objUsuario = new usuariosAjax();
