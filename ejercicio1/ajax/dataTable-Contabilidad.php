...
class dataTableUsuariosContabilidad{
    public function fnCargarTablaContabilidad(){
        $objRespuesta = usuariosControlador::fnCtrCargarContanbilidad();
...
$objTabla = new dataTableUsuariosContabilidad();
$objTabla->fnCargarTablaContabilidad();