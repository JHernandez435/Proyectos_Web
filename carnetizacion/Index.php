...
<body class="ana">
    ...
    <div class="row col-md-12">
        ...
        <br><br><br><br> 
        <a type="button" href='index1.php' class="btn btn-danger">Empresas</a>
...
<div id="modalCarnet" class="modal fade" role="dialog">
    <div class="modal-dialog">
...
<div class="modal-content" id="modal-color">
    ...
    <form enctype="multipart/form-data" class="carnet">
        ...
        <div class="form-group">
            <label id="txtEditarEdad">Edad:</label>
        </div>
        <div class="form-group">
            <img  id="imgImagen" urlimagen="" src="" width="150" height="150">
        </div>
...
<div class="modal-footer">
    <button type="button" class="btn btn-primary btnGuardar" id="btnImprimir" >Imprimir</button>
</div>
</div>
